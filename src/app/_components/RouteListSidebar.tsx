...
import { Copy, Calendar, MapPin, Clock, Download } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border bg-gradient-to-br from-green-50 to-blue-50 p-4">
              ...
              <div className="mt-4 space-y-2">
                ...
                {/* Share link button - only show when trip is saved */}
                {currentTrip?.savedTripData && (
                  <button
                    onClick={handleCopyShareLink}
                    className="w-full inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  >
                    <Copy className="h-4 w-4" />
                    Copy Share Link
                  </button>
